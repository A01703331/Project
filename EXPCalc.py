...
#Estas funciones definen la cantidad de experiencia que los Kuribake
# plateados dorados y platinos otorgan al ser derrotados
...
#Esta función definirá la cantidad de experiencia total para llegar al nivel
...
#cada vez que se repita, repitiendo el número de veces que indique la
#variable Levels_Needed
